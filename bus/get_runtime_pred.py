...
def getRunTimePrediction(model, start_datetime, end_datetime):
    db_config = {
        "host": "localhost",
        "user": "root",
    ...
    # start_datetime = "2021-10-02 06:00:00"
    # end_datetime = "2021-10-02 14:00:00"
    ...
    busses_new = initial[
        ['trip_id', 'deviceid', 'direction', 'segment', 'date', 'start_time', 'end_time', 'run_time_in_seconds']]
